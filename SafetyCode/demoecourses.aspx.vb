...
Partial Class demoecourses
    ...
    Protected Sub cartBtn_Click(sender As Object, e As System.EventArgs) Handles cartBtn.Click
        ...
        ProductID = CType(coursesGDV.SelectedRow.Cells(1).Text, Integer)
        coursesGDV.SelectedIndex = -1 'deselect
    ...
    Protected Sub coursesGDV_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles coursesGDV.SelectedIndexChanged
        lblWarning.Text = ""
    End Sub
End Class